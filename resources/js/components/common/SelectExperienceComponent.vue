        ...
        <div v-for="(experience, index) in experiences" :key="index">
            <div style="width:45%;display:inline-block">
                <select-box-component
                    @changeSelectedVal="
                        changeSelectedCategory($event, experience, index)
                    "
                    :target="'category'"
                    :baseData="categories"
                    :initVal="experience.category_id"
                ></select-box-component>
            </div>
            <div style="width:45%;display:inline-block">
                <input
                    type="number"
                    class="form-control"
                    v-model="experience.experience_years"
                    style="display: inline-block;width: 50%;margin-right: 10px;margin-bottom:5px;"
                />
