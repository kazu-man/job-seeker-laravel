    ...
    <div class="container">
        <div class="modal-mask" v-if="loading">
            ...
            <div class="video-there-area">
                <video v-show="videoOn" ref="video-there" autoplay class="video"></video>
                ...
                cameraSetUp(){
                    ...
                    axios.post('/api/findInterviewToken',data).then(res => {
                        ...
                        if(res.data.tokenFindFlg == 1){
                            ...
                            this.$store.dispatch('common/alertModalUp', {data:200, successMessage:'無効なトークンです'});
