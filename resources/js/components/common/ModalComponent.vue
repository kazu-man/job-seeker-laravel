    ...
    <div>
            ...
            <div class="modal-body">
                <form class="form" @submit.prevent="login">
                    ...
                    <div style="text-align:right;">
                        <span @click="registerFormShow" class="login-switch"
                            >登録する</span
                        >
                    </div>
                    <div style="text-align:right;">
                        <span @click="passworForgotModal" class="login-switch"
                            >パスワード忘れた</span
                        >
                    </div>
        ...
        >
            ...
            <div class="modal-body">
                <form class="form" @submit.prevent="register(false)">
                    ...
                    <div class="form-group row">
                        <label for="password-confirmation" class="col-4"
                    ...
                    <div class="form-group row" style="width:50%">
                        <input
                            ...
                            :value="false"
                        />
                        <label for="asUser" class="col-6 userType pointer"
                            >to find a job</label
                        >
                    </div>
                    <div class="form-group row" style="width:50%">
                        <input
                            ...
                            :value="true"
                        />
                        <label for="asCompany" class="col-6 userType pointer"
                            >to find workers</label
                        >
                    </div>
                    <div v-if="asCompany">
                        <div class="form-group row">
                    ...
                    <div style="text-align:right;">
                        <span class="login-switch" @click="loginFormShow"
                            >ログインする</span
                        >
                    </div>
        ...
        >
            <div class="modal-header">
                ...
                <p>Register Admin</p>
                <div v-on:click="modalHide('registerAdmin')" class="close">
                    X
                </div>
            </div>
            ...
            <div class="modal-body">
                <form
                    class="form"
                    @submit.prevent="register(true)"
                    style="padding:30px;margin-right:30px;overflow-y:scroll"
                >
        ...
        <modal name="changePassword" :draggable="false" class="changePassword">
            <div class="modal-header">
                ...
                <p>Change Password</p>
                <div v-on:click="modalHide('changePassword')" class="close">
                    X
                </div>
            </div>
            <div class="modal-body">
        ...
        <modal name="forgotPassword" :draggable="false" class="forgotPassword">
            <div class="modal-header">
                ...
                <p>Password Reset</p>
                <div v-on:click="modalHide('forgotPassword')" class="close">
                    X
                </div>
            </div>
            <div class="modal-body">
                <form class="form" @submit.prevent="login">
                    ...
                    <div class="form-group row">
                        <label
                            for="email"
                            class="col-3"
                            style="text-align:right;margin-bottom:0;vertical-align: top;padding-top:7px;"
                            >Email</label
                        >
                        <input
                            type="email"
                ...
                <div class="job-register-area">
                    <div class="form-group title-form">
                        ...
                        <input
                            type="text"
                            name="title"
                            v-model="editPostForm.job_title"
                            class="form-control"
                        />
                    </div>
                    <div class="form-group salary-form">
                        ...
                        <input
                            type="text"
                            name="salary"
                            v-model="editPostForm.annual_salary"
                            class="form-control"
                        />
                    </div>
                    ...
                    <div class="form-group place-form">
                        <place-show-component
                            ...
                            :initVal="editPostForm.city"
                            :initAddressObj="editPostForm.addressObj"
                            :initMarkers="editPostForm.latLng"
                    ...
                    <div class="form-group type-form">
                        ...
                        <select-tag-component
                            ...
                            :initialList="editPostForm.tagList"
                        ></select-tag-component>
                    </div>
                    ...
                    <div class="form-group requirement-form">
                        ...
                        <textarea
                            name="requirement"
                            v-model="editPostForm.requirement"
                            class="form-control"
                            rows="8"
                        ></textarea>
                    </div>
                    ...
                    <div class="form-group experience-fom">
                        ...
                        <textarea
                            name="experience"
                            v-model="editPostForm.experience"
                            class="form-control"
                            rows="8"
                        ></textarea>
                    </div>
                    ...
                    <video-upload-component
                        ...
                        :initVideo="editPostForm.video_url"
                    ></video-upload-component>
        ...
        <modal name="apply" :draggable="false" :height="'auto'" class="apply">
            ...
            <div class="modal-body" style="width:100%;">
                <div style="text-align:left;margin:auto;margin-left:20%">
                    <div v-if="applyTargetPost != null">
                        求人名：{{ applyTargetPost.job_title }}
                    </div>
                    <div v-if="applyTargetPost != null">
                        会社名：{{ applyTargetPost.company.company_name }}
                    </div>
                    <div v-if="applyTargetPost != null">
                        求人タイプ：{{ applyTargetPost.job_type.job_type }}
                    </div>
                    <div v-if="applyTargetPost != null">
                        勤務地：{{
                            applyTargetPost.city.province.province_name
                        }}
                        - {{ applyTargetPost.city.city_name }} -
                        {{ applyTargetPost.city.province.country.country_name }}
                    </div>
                    <div v-if="applyTargetPost != null">
                        給与：{{ applyTargetPost.annual_salary }}
                    </div>
                </div>
        ...
        >
            <div
                class="modal-header"
                v-if="applicantProfile != null"
                style="background:rgba(0, 0, 0, 0.03)"
            >
                <p>Applicant Profile</p>
                <div v-on:click="modalHide('applicantProfile')" class="close">
                    X
                </div>
            </div>
            ...
            >
                <div
                    v-if="applicantProfile.resume != null"
                ...
                <div class="row border mt-0 mx-4" style="border-radius:5px">
                    <div
                        class="col-md-6 col-sm-12 row  pr-2"
                        style="margin-top:12px"
                    >
                        <div class="col-4 pr-0"><strong>Name: </strong></div>
                        <div
                            class="col-8 text-left pr-0"
                            v-if="
                                applicantProfile.user.user_lastname != null &&
                                    applicantProfile.user.user_firstname != null
                            "
                        >
                            {{ applicantProfile.user.user_lastname }}
                            {{ applicantProfile.user.user_firstname }}
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-12 row  pr-2">
                        ...
                        <div
                            class="col-8 text-left pr-0"
                            v-if="applicantProfile.user.email != null"
                        >
                    ...
                    <div class="col-md-6 col-sm-12 row  pr-2">
                        ...
                        <div
                            class="col-8 text-left pr-0"
                            v-if="applicantProfile.user.user_birthday != 'null'"
                        >
                ...
                <div class="profile-item border m-4 p-3 mt-5">
                    <div class="h-3 profile-item-label">
                        <strong>Experience</strong>
                    </div>
                    <div
                        class="text-left"
                        v-for="ex in applicantProfile.experiences"
                        :obj="ex"
                        :key="ex.id"
                    >
                        <span style="width:20%">{{
                        ...
                        -
                        <span style="width:70%"
                            >{{ ex.experience_years }} years</span
                        >
                    </div>
                </div>
                ...
                <div
                    class="btn btn-info"
                    @click="modalHide('applicantProfile')"
                >
                    close
                </div>
            </div>
        ...
        >
            <div class="modal-header" style="position:relative;padding:3px;">
                <p v-if="loginUser != null && loginUser.user_type == 'U'">
                    Messages <br />
                    <span class=" message-to"
                        >[ To: {{ applyRecord.companyName }} ]</span
                    >
                </p>
                <p v-else-if="loginUser != null && loginUser.user_type == 'C'">
                    Messages <br /><span class=" message-to"
                        >[ To: {{ applyRecord.applicantName }} ]</span
                    >
                </p>
                <div v-on:click="modalHide('messageModal')" class="close">
                    X
                </div>
                <div
                    class="btn btn-info interview-btn"
                    @click="interviewPopUpFlg = !interviewPopUpFlg"
                    v-if="loginUser != null && loginUser.user_type == 'C'"
                >
                    interview
                </div>
            </div>
            ...
            <div
                class="messages-area"
                id="messages-area"
                style="height:374px;overflow-y:scroll"
                v-if="messagesList != null"
            >
                    ...
                    <transition-group name="message">
                        ...
                        >
                            <div
                                v-if="
                                    loginUser != null &&
                                        loginUser.user_type == message.sent_to
                                "
                            >
                                <div
                                    class="company-logo-message"
                                    v-if="message.sent_to == 'U'"
                                >
                                    <img
                                        v-if="applyRecord.companyLogo != null"
                                        :src="applyRecord.companyLogo"
                                        class="m-auto p-auto image rounded-circle company-logo-image"
                                        alt="image"
                                    />
                                    <img
                                        v-else
        ...
        <modal name="postClose" :draggable="false" class="postClose">
            <div v-if="singlePost != null" class="modal-header">
                <p v-if="singlePost.job_status == 'A'">
                    こちらの求人を非表示にしますか？
                </p>
            ...
            <div class="modal-body" style="width:90%;">
                <div style="text-align:left;margin:auto">
                    <div v-if="singlePost != null">
                        求人名：{{ singlePost.job_title }}
                    </div>
                    <div v-if="singlePost != null">
                        会社名：{{ singlePost.company.company_name }}
                    </div>
                    <div v-if="singlePost != null">
                        求人タイプ：{{ singlePost.job_type.job_type }}
                    </div>
                    <div v-if="singlePost != null">
                        勤務地：{{ singlePost.city.province.province_name }} -
                        {{ singlePost.city.city_name }} -
                        {{ singlePost.city.province.country.country_name }}
                    </div>
                    <div v-if="singlePost != null">
                        給与：{{ singlePost.annual_salary }}
                    </div>
                </div>
                ...
                <div class="row" style="margin-top:25px;">
                    <div class="col-6">
                        <button
                            v-on:click="modalHide('postClose')"
                            name="closePost"
                            class="btn btn-block btn-warning btn-md p-2 text-danger"
                        >
                            <span class="icon-heart-o mr-2 text-danger"
        ...
        >
            <div class="modal-header">
                <p>背景の変更</p>
                <div v-on:click="modalHide('bgChangeModal')" class="close">
                    X
                </div>
            </div>
            <div
                class="modal-body"
                style="width:100%;"
                v-if="countryForm != null"
            >
                <div class="form-group">
                    <label> Country Name: {{ countryForm.countryName }} </label>
                    <div style="width:50%;margin:auto">
                        <label for="modalCountryBg">
                            <input
                                ...
                                class="p-3"
                                style="display:none"
                                @change="countryBgChange"
                            />
                            <div
                                style="display:inline-block;margin-left:10px;width:100%;"
                            >
                                <div>Background image :</div>
                            </div>
                            <img
                                v-if="modalCurrentBgImage != null"
                                :src="modalCurrentBgImage"
                                class="m-auto p-auto image country-bg-image"
                                alt="image"
                            />
                            <img
                                v-else-if="countryForm.countryImage != null"
                                :src="countryForm.countryImage"
                                class="m-auto p-auto image country-bg-image"
                                alt="image"
                            />
                            <img
                ...
                <p
                    v-if="
                        deleteTargetUser != null &&
                            deleteTargetUser.user_status == 'A'
                    "
                >
                    こちらのユーザをログイン不可に変更しますか？
                </p>
                <p v-else>こちらのユーザをログイン可能に変更しますか？</p>
                <div v-on:click="modalHide('deleteUserModal')" class="close">
                    X
                </div>
            </div>
            <div class="modal-body" style="width:100%;padding-top:40px;">
                <div style="text-align:left;margin-left:15%">
                    <div v-if="deleteTargetUser != null">
                        ユーザ名　　：{{ deleteTargetUser.user_firstname }}
                        {{ deleteTargetUser.user_lastname }}
                    </div>
                    <div v-if="deleteTargetUser != null">
                        e-mail　　　 ：{{ deleteTargetUser.email }}
                    </div>
                    <div v-if="deleteTargetUser != null">
                        ユーザタイプ：{{ deleteTargetUser.user_type }}
                    </div>
                </div>
                ...
                <div class="row button-area">
                    <div class="col-6">
                        <button
                            @click="modalHide('deleteUserModal')"
                            name="deleteUserModal"
                            class="btn btn-block btn-warning btn-md p-2 text-danger"
                        >
                            <span class="icon-heart-o mr-2 text-danger"
        ...
        >
            ...
            >
                <div class="scout-job-area">
                    ...
                    <div
                        v-if="scoutInfo.id != null"
                        class="scout-job-check-area"
                    >
                        <div
                            v-for="job in scoutInfo.sender.company.jobs"
                            :obj="job"
                            :key="job.id"
                            class="scout-job-check"
                        >
                            <input
                                type="checkbox"
                                :id="job.id"
                                name="registeredJobs"
                                :value="job.id"
                                v-model="scoutInfo.scoutJobList"
                                disabled="true"
                            />
                            <label :for="job.id" style="display: inline;">{{
                                job.job_title
                            }}</label>
                        </div>
                    </div>
                    <div v-else class="scout-job-check-area">
                        <div
                            v-for="job in scoutInfo.registeredJobs"
                            :obj="job"
                            :key="job.id"
                            class="scout-job-check"
                        >
                ...
                <div v-if="scoutInfo.id != null">
                    <div style="margin-top: 10px;text-align:left;">
                        Scout Message has been sent
                        <span
                            style="font-size: 12px;float: right;padding-top: 5px;"
                            >({{ scoutInfo.created_at }})</span
                        >
                    </div>
                    <div class="sent-scout-message">
                        {{ scoutInfo.scout_message }}
                    </div>
                </div>
                <div v-else>
                    <div style="margin-top: 10px;text-align:left;">
                    ...
                    <div>
                        <textarea
                            class="form-control"
                            rows="10"
                            v-model="scoutInfo.scout_message"
                        ></textarea>
                    </div>
                </div>
                ...
                <div class="row button-area">
                    <div
                        class="col-6"
                        :class="{ width30: scoutInfo.id != null }"
                    >
                        <button
                            @click="modalHide('scoutModal')"
                            name="scoutModal"
                            class="btn btn-block btn-warning btn-md p-2 text-danger"
                        >
                            <span class="icon-heart-o mr-2 text-danger"
        ...
        >
            ...
            <div class="interviewPopUp">
                <InterviewCalendarComponent
                    ref="interviewComponent"
                ></InterviewCalendarComponent>
            </div>
        </modal>

        <modal
            name="interviewConfirmModal"
            :draggable="false"
            class="interviewConfirmModal"
        >
            <div class="modal-header">
                <p v-if="interviewCancelTarget != null">
                    <span
                        v-if="
                            interviewCancelTarget.extendedProps != null &&
                                interviewCancelTarget.extendedProps.data
                                    .user_type == 'C'
                        "
                        >受験者</span
                    >
                    <span v-else>企業名</span>
                    ：{{ interviewCancelTarget.title }}
                </p>
                <div
                    v-on:click="modalHide('interviewConfirmModal')"
                    class="close"
                >
                    X
                </div>
            ...
            <div class="modal-body" style="width:100%;padding-top:40px;">
                <div>
                    <div v-if="interviewCancelTarget.start != null">
                        日時：{{
                            interviewCancelTarget.start.toLocaleString("ja")
                        }}
                    </div>
                    <div v-if="interviewCancelTarget.extendedProps != null">
                        予定時間：{{
                            interviewCancelTarget.extendedProps.data
                                .video_duration
                        }}
                ...
                <div class="row button-area" style="margin-top:30px">
                    ...
                    >
                        <button
                            v-bind:disabled="
                                checkInterviewTime(interviewCancelTarget.start)
                            "
                            @click="
                                startVideoChat(
                                    interviewCancelTarget.extendedProps.data
                            ...
                            "
                            name="interviewConfirmModal"
                            class="btn btn-block btn-warning btn-md p-2 text-danger interviewConfirmModalBtn"
                        >
                            <span class="icon-heart-o mr-2 text-danger"
                                >開始する</span
                            >
                    ...
                    >
                        <button
                            v-bind:disabled="
                                checkInterviewTime(interviewCancelTarget.start)
                            "
                            @click="cancelInterviewConfirm"
                            type="button"
                            class="btn btn-primary p-2 btn-block interviewConfirmModalBtn"
                        >
                            キャンセルする
                        </button>
                    </div>
        ...
        <modal
            name="interviewCancelConfirmModal"
            :draggable="false"
            :resizable="false"
            :height="'auto'"
            :width="320"
            class="interviewCancelConfirmModal"
        >
            <div class="modal-header">
            ...
            <div class="modal-body" style="width:90%;">
                <div class="row">
                    <div class="col-6">
                        <button
                            v-on:click="
                                modalHide('interviewCancelConfirmModal')
                            "
                            name="closePost"
                            class="btn btn-block btn-warning btn-md p-2 text-danger"
                        >
        ...
        >
            ...
            <div v-on:click="modalHide('alert')" class="btn btn-success">
                閉じる
            </div>
        </modal>
        <modal
            name="relordAfterAlert"
            :draggable="false"
            :resizable="false"
            :height="150"
            :width="300"
...
export default {
    ...
    methods: {
        ...
        modalHide: async function(target) {
            ...
            var reloadFlg =
                this.$store.state.common.alertModalMessage != null
                    ? this.$store.state.common.alertModalMessage.reload
                    : true;
        ...
        initEditPostModal: function() {
            ...
            if (
                postInfo.addressObj != null &&
                postInfo.addressObj != undefined
            ) {
                this.editPostForm.latLng = {
                    lat: postInfo.addressObj.lat,
                    lng: postInfo.addressObj.lng
                };
            }
        },
        updatePost: function() {
            ...
            axios.post("/api/updatePost", this.editPostForm).then(res => {
                ...
                this.$store.dispatch("common/alertModalUp", {
                    data: res.status,
                    successMessage: "postを更新しました。"
                });
                this.$store.commit(
                    "common/setUpdatedPost",
        ...
        setUpInterview: function() {
            ...
            if (this.interviewForm.interviewDate == "") {
                this.$store.dispatch("common/alertModalUp", {
                    data: 200,
                    successMessage: "面接日を入力して下さい"
                });
                reutrn;
            } else if (this.interviewForm.interviewTime == "") {
                this.$store.dispatch("common/alertModalUp", {
                    data: 200,
                    successMessage: "面接時間を入力して下さい"
                });
                reutrn;
            } else if (this.interviewForm.interviewDuration == "") {
                this.$store.dispatch("common/alertModalUp", {
                    data: 200,
                    successMessage: "面接予定時間を入力して下さい"
                });
                reutrn;
            } else {
                this.$store.commit("common/setLoadingFlg", true);
                axios
                    .post("/api/setUpInterview", this.interviewForm)
                    .then(res => {
                        this.$store.commit("common/setLoadingFlg", false);

                        this.$store.dispatch("common/alertModalUp", {
                            data: res.status,
                            successMessage: "面接を予約しました"
                        });
                        this.$store.dispatch(
                            "common/refreshMessage",
                            this.applyRecord.id
        ...
        closePost() {
            ...
            axios
                .post("/api/closePost", { targetPostId: this.singlePost.id })
                .then(res => {
                    this.$store.commit("common/setLoadingFlg", false);
        ...
        scrollBottomOfMessage: function() {
            setTimeout(() => {
                var scrollPosition = document.getElementById("messages-area")
                    .scrollTop;
                var scrollHeight = document.getElementById("messages-area")
                    .scrollHeight;
        ...
        updateCountry: async function() {
            if (this.countryForm.countryName == "") {
                this.$store.dispatch("common/alertModalUp", {
                    data: OK,
                    successMessage: "国名を入力してください"
                });
                return;
            } else if (this.countryForm.modalUploadedFile == null) {
                this.$store.dispatch("common/alertModalUp", {
                    data: OK,
                    successMessage: "背景を選択してください。",
                    close: false
                });
                return;
            }
            ...
            await axios.post("/api/registerCountry", formData).then(res => {
                ...
                this.$store.dispatch("common/alertModalUp", {
                    data: res.status,
                    successMessage: "背景を更新しました。"
                });
                this.$store.commit(
                    "common/setSettingCountryReloadFlg",
                    !this.settingCountryReloadFlg
                );
        ...
        async changePassword() {
            this.$store.commit("common/setLoadingFlg", true);
            await axios
                .post("/api/passwordUpdate", this.passwordResetForm)
                .then(res => {
                    this.$store.commit("common/setLoadingFlg", false);
                    if (res.status != 200) {
                        return false;
        ...
        async forgotPassword() {
            ...
            await axios
                .post("/api/password/email", this.forgotPasswordForm)
                .then(res => {
                    this.$store.commit("common/setLoadingFlg", false);
        ...
        sendScout: function() {
            if (this.scoutInfo.scoutJobList.length < 1) {
                this.$store.dispatch("common/alertModalUp", {
                    data: OK,
                    successMessage: "スカウトする求人を選択して下さい",
                    close: false
                });
                return;
            }
            this.$store.commit("common/setLoadingFlg", true);
            axios
                .post("/api/sendScout", this.scoutInfo)
                .then(res => {
                    this.$store.commit("common/setLoadingFlg", false);
                    if (res.status != 200) {
                        return false;
                ...
                .catch(res => {
                    ...
                    this.$store.dispatch("common/alertModalUp", {
                        data: res.status,
                        successMessage: "スカウトメッセージ送信に失敗しました。"
                    });
                });
        },
        ...
        cancelInterview: function() {
            ...
            axios
                .post("/api/cancelInterview", {
                    id: this.interviewCancelTarget.id
                })
                .then(res => {
                    this.$store.commit("common/setLoadingFlg", false);
                    if (res.status != 200) {
                    ...
                    this.$store.dispatch("common/alertModalUp", {
                        data: res.status,
                        successMessage: "WEB面接をキャンセルしました。",
                        close: true
                    });
                    this.$refs.interviewComponent.removeInterview(
                        this.interviewCancelTarget.id
                    );
                })
                .catch(res => {
                    this.$store.commit("common/setLoadingFlg", false);
                    ...
                    this.$store.dispatch("common/alertModalUp", {
                        data: res.status,
                        successMessage: "キャンセル処理でエラーが発生しました。"
                    });
                });
        },
        startVideoChat: function(data) {
            window.open(
                data.video_url,
                "name",
                "width=900, height=620, top=0, left=0, personalbar=0, toolbar=0, scrollbars=1, resizable=!"
            );
        },
        checkInterviewTime: function(time) {
            var interviewTime = new Date(time);
            var interviewNextDate = interviewTime.setDate(
                interviewTime.getDate() + 1
            );
            var now = new Date();
    ...
    computed: {
        ...
        alertModalMessage() {
            ...
            var message = this.$store.state.common.alertModalMessage
                .successMessage;

            if (
                this.alertModalStatus != null &&
                this.alertModalStatus == UNAUTHORIZED
            ) {
        ...
        resumeName: function() {
            if (this.applicantProfile.resume != null) {
                return this.applicantProfile.resume.substr(
                    this.applicantProfile.resume.lastIndexOf("/") + 1
                );
            }
        },
        scoutInfo: function() {
    ...
    watch: {
        ...
        liveMessage: function(val, old) {
            if (
                document.getElementById("messages-area") != undefined &&
                this.applyRecord != undefined &&
                this.applyRecord.id == val.message.applyId
            ) {
                this.$store.dispatch(
                    "common/refreshMessage",
                    val.message.applyId
...
.scout-job-check input,
.scout-job-check label {
    cursor: pointer;
}
