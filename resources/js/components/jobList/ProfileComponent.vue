        ...
        <div class="card-body ">
            <form class="form" @submit.prevent="updateProfile">
                ...
                <div
                    v-if="
                        this.$store.state.auth.user != null &&
                            this.$store.state.auth.user.user_type == 'U'
                    "
                >
                    <div class="form-group">
...
export default {
    ...
    methods: {
        updateProfile() {
            ...
            formData.append(
                "experiences",
                JSON.stringify(this.profileForm.experiences)
            );
    ...
    created: function() {
        ...
        this.profileForm.userLastname =
            user_lastname != null ? user_lastname : "";
        this.profileForm.userFirstname =
            user_firstname != null ? user_firstname : "";
        this.profileForm.userBirthday =
    ...
    computed: {
        resumeName: function() {
            if (this.currentResume != null) {
                return this.currentResume.substr(
                    this.currentResume.lastIndexOf("/") + 1
                );
            }
        }
    }
