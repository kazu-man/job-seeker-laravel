        ...
        <div class="place-forms">
            ...
            <div class="form-group">
                ...
                <select
                    ...
                    v-model="provinceForm.countryId"
                >
                    <option value="" disabled selected style="display:none;"
                        >選択してください</option
                    >
                    <option
                        v-for="obj in countries"
                        :key="obj.id"
                        :value="obj.id"
                    >
                        {{ obj.country_name }}
                ...
                <input
                    type="text"
                    name="province"
                    v-model="provinceForm.provinceName"
                    class="form-control"
                />

                <div>
                    <button
                        v-on:click="registerProvince"
                        class="btn register-btn"
                    >
                        Submit
                    </button>
            ...
            <div class="form-group">
                ...
                />
                <div>
                    <button v-on:click="registerCity" class="btn register-btn">
                        Submit
                    </button>
                </div>
            </div>
    ...
    methods: {
        ...
        registerProvince: function() {
            ...
            if (this.provinceForm.countryId == "") {
                this.$store.dispatch("common/alertModalUp", {
                    data: OK,
                    successMessage: "国を選択してください。"
                });
                return;
            } else if (this.provinceForm.provinceName == "") {
                this.$store.dispatch("common/alertModalUp", {
                    data: OK,
                    successMessage: "地域を入力してください"
                });
                return;
            }
            this.$store.commit("common/setLoadingFlg", true);
        ...
        registerCity: function() {
            ...
            if (this.cityForm.countryId == "") {
                this.$store.dispatch("common/alertModalUp", {
                    data: OK,
                    successMessage: "国を入力してください"
                });
                return;
            } else if (this.cityForm.provinceId == "") {
                this.$store.dispatch("common/alertModalUp", {
                    data: OK,
                    successMessage: "地域を選択してください。"
                });
                return;
            } else if (this.cityForm.cityName == "") {
                this.$store.dispatch("common/alertModalUp", {
                    data: OK,
                    successMessage: "都市名を入力してください"
                });
                return;
            }
            var that = this;
        ...
        setProvince: function() {
            ...
            this.loading = true;
            axios
                .get("/api/getTargetProvinces/" + this.cityForm.countryId)
                .then(res => {
