    ...
    <div class="place-show-area">
        ...
        <div>
            <div class="mapButtonArea">
                <p v-if="!mapShow" @click="mapAreaShow">
                    <span class="add-btn">+</span> 地図を表示する
                </p>
                <p v-else @click="mapAreaShow">
                    <span class="add-btn">-</span> 地図を表示しない
                </p>
            </div>
                ...
                <div class="mapListArea" v-show="mapShow">
                    <div class="mapTypeArea">
                        <div style="padding:0 0 3px 0">
                            <span style="width:16%; display: inline-block;"
                                >国：</span
                            >{{
                                checkedCountry != "" && checkedCountry != null
                                    ? checkedCountry.country_name
                                    : ""
                            }}
                        </div>
                        <div style="padding:3px 0">
                            <span style="width:16%; display: inline-block;"
                                >都市：</span
                            >{{
                                checkedProvince != "" && checkedProvince != null
                                    ? checkedProvince.province_name
                                    : ""
                            }}
                        </div>
                    </div>
                    <div>
                        ...
                        <input
                            ...
                            class="form-control"
                            v-model="addressObj.address_line_1"
                        />
                    </div>
                    <label style="width:16%;">
                        住所2:
                    ...
                    <input
                        ...
                        style="width:78%;display:inline-block"
                        class="form-control"
                        v-model="addressObj.address_line_2"
                    />
                    <label style="width:16%;">
                        郵便番号:
                    </label>
...
<script>
var placeShowListComponent = Vue.component(
    "placeShowListComponent",
    require("./PlaceShowList.vue").default
);
...
export default {
    data() {
        return {
            ...
            mapZoom: 4,
            markers: [{ position: { lat: 35.4122, lng: 139.413 } }],
            updatedMarker: false,
    ...
    created: function() {
        if (
            this.initMarkers != null &&
            this.initMarkers.lat != null &&
            this.initMarkers.lat != undefined
        ) {
            this.mapShow = true;
        ...
        updateCountry: function() {
            ...
            axios.get("/api/getCountries").then(res => {
                ...
                if (
                    ...
                    this.initVal.province != undefined &&
                    this.initVal.province != ""
                ) {
                    for (var country of res.data) {
                        if (
                            this.initVal.province.country.country_name ==
            ...
            axios.post("/api/getProvinces", { id: $id }).then(res => {
                ...
                if (
                    ...
                    for (var province of res.data) {
                        if (
                            this.initVal.province.province_name ==
    ...
    watch: {
        ...
        checkedCountry: function($el) {
            ...
            this.addressObj.country =
                $el != undefined && $el != "" ? $el.country_name : "";
        },
        checkedProvince: function($el) {
            if ($el != "" && $el != undefined) {
                ...
                this.mapZoom = 8;
                this.addressObj.city =
                    $el != undefined && $el != "" ? $el.province_name : "";
            }
        },
        checkedCity: function($el) {
            ...
            //初期マップがある場合はそれを表示
            if (
                this.initAddressObj != null &&
                this.initAddressObj != undefined &&
                this.initMarkers.lat != null &&
                this.initMarkers.lat != undefined &&
                !this.updatedMarker
            ) {
